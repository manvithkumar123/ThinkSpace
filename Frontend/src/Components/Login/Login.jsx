        ...
        <div className="forgot_password_page">
          <div className="forgot_block">
            <form onSubmit={handleforgotpassword} >
              ...
              <label>
                <p style={{ marginLeft: "5px", marginTop: "5px" }}>Email Address</p>
                <input type="text" placeholder='Email address' onChange={(e) => setForgotemail(e.target.value)} value={forgotemail} autoComplete="username" />
              </label>
              <label>
                <p style={{ marginLeft: "5px", marginTop: "5px" }}>Key</p>
                <input type="password" placeholder='key' onChange={(e) => setForgotkey(e.target.value)} value={forgotkey} autoComplete="key" />
              </label>
              <label>
                <p style={{ marginLeft: "5px", marginTop: "5px" }}>New Password</p>
                <input type="password" placeholder='New password' onChange={(e) => setNewpassword(e.target.value)} value={newpassword} autoComplete="new-password" />
              </label>
              <button className='login_submit_button' style={{ marginLeft: "5px", marginTop: "20px" }} type="submit">Submit</button>
            </form>
          </div>
        </div>
        : null}
      <div className="login_signup_container">
          ...
          <form onSubmit={handlelogin} >
            ...
            <div className="login_Credentials_container">
              <div className="username_input_container">
                <p style={{ marginLeft: "5px", marginTop: "5px" }}>Email Address</p>
                <input type="text" className='login_input' placeholder='Enter Email Address' value={email} onChange={(e) => setEmail(e.target.value)} autoComplete="username" />
              </div>
              <div className="username_input_container">
                ...
                <p
                  style={{ marginLeft: "70%", width: "max-content", marginTop: "7px", cursor: "pointer", color: "#0048FF" }}
                  onClick={(e) => {
                    e.preventDefault();
                    setForgotpage(true);
                  }}
            ...
            <p id='bottom_right_new_user' style={{ marginLeft: "60%", width: "max-content", marginRight: '40px', cursor: "pointer" }} onClick={(e) => { e.preventDefault(); setslide(!slide) }}>New user <span style={{ color: "#0048FF" }} >signup?</span></p>
          </form>
        </div>
        <div className="signup_container">
          <form onSubmit={handlesignup} >
            ...
            <div className="login_Credentials_container">
              <div className="username_input_container">
                <p style={{ marginLeft: "5px", marginTop: "10px" }}>Email Address</p>
                <input type="text" className='login_input' placeholder='Enter Email Address' value={signupEmail} onChange={(e) => setSignupEmail(e.target.value)} autoComplete="username" />
              </div>
              <div className="username_input_container">
                <p style={{ marginLeft: "5px", marginTop: "5px" }}>Password</p>
              ...
              <div className="username_input_container">
                ...
                <input type="text" autoComplete="name" className='login_input' placeholder='Enter Name' value={name} onChange={(e) => setName(e.target.value)} />
              </div>
              <div className="username_input_container">
                <p style={{ marginLeft: "5px", marginTop: "5px" }}>Key</p>
              ...
              <button className='login_submit_button' style={{ marginLeft: "5px" }} type="submit">Submit</button>
            </div>
            <p id='bottom_right_new_user' style={{ cursor: "pointer" }} onClick={(e) => { e.preventDefault(); setslide(!slide) }}>Already a user <span style={{ color: "#0048FF" }}>Login?</span></p>
          </form>
        </div>
      </div>
    </div>
